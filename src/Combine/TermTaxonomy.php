...
class TermTaxonomy extends Model
{
    ...
    {
        return $this->belongsTo('Combine\Term', 'term_id');
    }

    public function parentTerm()
    {
        return $this->belongsTo('Combine\TermTaxonomy', 'parent');
    }

    public function posts()
    {
        return $this->belongsToMany('Combine\Post', 'wp_term_relationships', 'term_taxonomy_id', 'object_id');
    }
