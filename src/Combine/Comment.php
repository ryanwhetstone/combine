...
class Comment extends Eloquent
{
    ...
    {
        return $this->belongsTo('Combine\Post', 'comment_post_ID');
    }
    ...
    {
        return $this->belongsTo('Combine\Comment', 'comment_parent');
    }
    ...
    {
        return $this->hasMany('Combine\Comment', 'comment_parent');
    }
